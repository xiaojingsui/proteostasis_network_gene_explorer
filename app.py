...
# ==========================================
    ...
    <style>
        ...
        div[data-testid="stAlert"] p {
            background-color: #FFFFFF !important;
            color: #000000 !important; /* Text color to match your theme */
        }
    </style>
    """, unsafe_allow_html=True)
...
Example (TAB2): TAB2 binds BECN1 to inhibit autophagy (PMID 21976705, Figure X B-D); TAB2 interacts with ATG13 and is phosphorylated by ULK1 (PMID 21976705, Figure Y C).""",
